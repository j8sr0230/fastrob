...
from utils import slice_stl, parse_g_code  # noqa
...
class SliceObject:
    def __init__(self, feature_obj: Part.Feature, mesh: Mesh.Feature) -> None:
        ...
        feature_obj.addProperty("App::PropertyInteger", "Layer", "Inspection", "Layer to be evaluated", 0).Layer = -1
        feature_obj.addProperty("App::PropertyInteger", "Position", "Inspection", "Position to be evaluated")
...
#         view_obj.addProperty("App::PropertyInteger", "Position", "Inspection", "Position to be inspected").Position
#
